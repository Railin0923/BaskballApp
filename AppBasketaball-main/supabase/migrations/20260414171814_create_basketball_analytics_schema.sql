...
/*
  ...
  - id, game_id, player_id, user_id
  - points, assists, rebounds_off, rebounds_def, steals, blocks, turnovers, minutes
  - fgm, fga, three_pm, three_pa, ftm, fta

  ### shots
  Every individual shot attempt with court coordinates and metadata.
  - id, game_id, player_id, user_id
  - x, y (0-500 and 0-470 normalized court coords)
  - shot_type (2PT, 3PT, FT), made (bool), zone (paint/mid_range/corner_3/top_3/free_throw)
